...
import { subscribe as chargilySubscribe } from '@/routes/chargilypay';
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                    <nav className="flex items-center justify-end gap-4">
                        <Link
                            href={chargilySubscribe()}
                            className="inline-block rounded-sm border border-[#19140035] bg-[#1b1b18] px-5 py-1.5 text-sm leading-normal text-white shadow-sm shadow-[#1b1b18]/30 transition hover:-translate-y-0.5 hover:shadow dark:border-[#3E3E3A] dark:bg-[#EDEDEC] dark:text-[#1C1C1A] dark:shadow-none"
                        >
                            Test ChargilyPay
                        </Link>
                        {auth.user ? (
